  ...
  return (
    <Fragment>
      ...
      <Container>
        ...
        <p>
          Each card represents a block on a chain. Click on a block to see the
          transaction.
        </p>
      </Container>
        ...
        <Grid container spacing={2} style={{ flexWrap: "nowrap" }}>
          {blocks.map((item, idx) => (
            <Grid item xs={3} key={idx + item.timestamp}>
              <Paper
                onClick={() => showTransactions(idx, item)}
                style={
                  idx === isblockSelected
                    ? styles.selectedpaperStyle
                    : styles.paperStyle
                }
              >
                ...
                <div style={styles.textBlock}>
                  ...
                  <p
                    style={{
                      ...styles.blockBody,
                      color: "#" + item.previousHash.substring(0, 6),
                    }}
                  >
                    {item.previousHash}
                  </p>
                ...
                <div style={styles.textBlock}>
                  ...
                  <p style={{ ...styles.blockBody, color: colors.darkText }}>
                    {item.nonce}
                  </p>
                </div>
                <Divider />
